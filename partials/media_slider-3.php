...
<?php 
  ...
  if($features): ?>
  <div class="fs-row"><div class="fs-cell fs-lg-10 fs-md-5 fs-sm-3 fs-centered"><div class="archive__slider fs__carousel" data-carousel-options='{"contained":false}'>
...
<div class="hero archive__slider-slide slider hero relative bg--gray hero--overlay hero--bg" style="margin-right: 25px; background-image: url(<?php echo $thumb_url; ?>);">
  ...
  <div class="centered centered--full show--onhover">
    <div class="fs-row">
  ...
  <div class="archive__slider-slide__footer footer pinned pinned--bottom text-center">
    <div class="fs-row">
      <div class="fs-cell fs-all-full">
        <div class="wrapper">
          <?php echo featured_category(); ?>
          <span class="accent color--white"><?php the_title(); ?></span>
        </div>
      </div>
    </div> 
  </div>
