...
<div class="hero hero--md relative bg--gray hero--overlay hero--bg" style="background-image: url(<?php echo $thumb_url; ?>);">
...
<br>
<span class="title title__md color--white"><?php the_title(); ?></span><br><br>
